...
namespace GraphQL.Extensions.Pagination {
    public class CursorInjector<TSource, TResult>
        ...
        public CursorInjector(OrderByInfo<TSource> orderBy) => OrderBy = orderBy;
        ...
        public Expression<Func<TSource, TResult>> InjectIntoSelector(Expression<Func<TSource, TResult>> originalSelector) {
            ...
            CursorVisitor<TSource, TResult> cursorVisitor = new CursorVisitor<TSource, TResult>(parameterExpression);
